...
<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="py-1">
            <span class="text-muted">  <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright EPIC FH')); ?> <?php echo e(date('Y')); ?></span>
        </div>
    </div>
</footer>
...
<?php /**PATH /Users/reyrockstreet/Sites/epic-fh/resources/views/partials/admin/footer.blade.php ENDPATH**/ ?>