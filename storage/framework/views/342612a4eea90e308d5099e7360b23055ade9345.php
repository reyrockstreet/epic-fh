                ...
                <a class="navbar-brand" href="#">
                    ...
                    <?php if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' ): ?>
                        <img src="<?php echo e($logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png')); ?>"
                             alt="<?php echo e(config('app.name', 'FH-Management-System')); ?>" class="logo w-50">
                    <?php else: ?>
            ...
            <div class="row align-items-center text-start">
                ...
                <div class="col-xl-6 img-card-side">
                    <div class="auth-img-content">
                        ...
                        <p class="text-white">
                            The more effortless the gamer looks, the more effort the
                            gamer actually put into the process.
                        </p>
                    </div>
                </div>
            </div>
...
<?php /**PATH /Users/reyrockstreet/Sites/epic-fh/resources/views/layouts/auth.blade.php ENDPATH**/ ?>