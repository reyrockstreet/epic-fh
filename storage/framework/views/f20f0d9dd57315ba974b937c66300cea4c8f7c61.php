    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('role',$rolese,null,array('class'=>'form-control select'))); ?>
...
<?php /**PATH /Users/reyrockstreet/Sites/epic-fh/resources/views/documentUpload/create.blade.php ENDPATH**/ ?>