...
class AccountGamesController extends Controller
{
    ...
    public function index()
    {
        ...
        {
            $accounts = AccountGames::where('created_by', '=', \Auth::user()->creatorId())->get();

            return view('accountGames.index', compact('accounts'));
        }
        else
        {
