...
use App\Http\Controllers\ReportGoldController;
use App\Http\Controllers\AccountGamesController;
...
Route::get('/home', [ReportGoldController::class, 'index'])->name('reportgold.index')->middleware(['XSS', 'revalidate',]);
Route::get('/', [ReportGoldController::class, 'index'])->name('reportgold.index')->middleware(['XSS', 'revalidate',]);
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        ...
        Route::resource('account-games', AccountGamesController::class);
    }
    );
    ...
    Route::get('reportgold/index', [ReportGoldController::class, 'index'])->name('reportgold.index')->middleware(['auth', 'XSS', 'revalidate']);

    Route::resource('reportgold', ReportGoldController::class)->middleware(['auth', 'XSS', 'revalidate']);
...
//    Route::get('/bill/{id}/', 'PurchaseController@purchaseLink')->name('purchase.link.copy');
   ...
   //Proposal/Invoice/Bill/Purchase/POS - footer notes
    ...
    Route::get('generate/{template_name}',[TemplateController::class,'create'])->name('generate');
    Route::post('generate/keywords/{id}',[TemplateController::class,'getKeywords'])->name('generate.keywords');
    Route::post('generate/response',[TemplateController::class,'process'])->name('generate.response');

    //AI module for grammar check
    Route::get('grammar/{template}',[TemplateController::class,'grammar'])->name('grammar')->middleware(['auth','XSS']);;
    Route::post('grammar/response',[TemplateController::class,'grammarProcess'])->name('grammar.response')->middleware(['auth','XSS']);;
