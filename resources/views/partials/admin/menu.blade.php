...
{{--                <img src="{{ asset(Storage::url('uploads/logo/'.$logo)) }}" alt="{{ env('APP_NAME') }}" class="logo logo-lg" />--}}
                ...
                @if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' )
                    <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') }}"
                         alt="{{ config('app.name', 'FH-Management-System') }}" class="logo logo-lg">
                @else
                ...
                <ul class="dash-navbar">
                    ...
                    @if(\Auth::user()->type!='super admin' && ( Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage client')))
                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'users' || Request::segment(1) == 'roles'
                            ...
                            <ul class="dash-submenu">
                                @can('manage user')
                                    <li class="dash-item {{ (Request::route()->getName() == 'reportgold.index' || Request::route()->getName() == 'reportgold.create' || Request::route()->getName() == 'reportgold.edit' || Request::route()->getName() == 'user.userlog') ? ' active' : '' }}">
                                        <a class="dash-link" href="{{ route('reportgold.index') }}">Report Gold</a>
                                    </li>
                                @endcan
                            ...
                            <li class="dash-item dash-hasmenu
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if( Gate::check('manage bank account') ||  Gate::check('manage bank transfer'))
                                        <li class="dash-item {{ (Request::route()->getName() == 'account-games.index' || Request::route()->getName() == 'account-games.create' || Request::route()->getName() == 'account-games.edit') ? ' active' : '' }}">
                                            <a class="dash-link" href="{{ route('account-games.index') }}">Account</a>
                                        </li>
                                    @endif
                                </ul>
                            </li>
            ...
            @endif
                ...
                <div class="navbar-footer border-top ">
                    <div class="d-flex align-items-center py-3 px-3 border-bottom">
                        ...
                        <div>
                            <b class="d-block f-w-700">{{__('Epic FH System')}}</b>
